 ...
 * @author fmfr
 */
public class ListaEstaticaString {
    

    private String[] v;
    private int tamanho;

    public ListaEstaticaString(int n) {
        v = new String[n];
        tamanho = 0;
    }
    ...
    public int indiceDoValor(String valor) {
        for (int i = 0; i < tamanho; i++) {
            if (valor == v[i]) {
                return i;
            }
    ...
    public String retornarElementoMeio() {
        return v[tamanho / 2];
    }
    //Questao 2
    ...
    public String retornarElemento(int pos) {
        return v[pos];
    }
    //Questao 4
    ...
    public void redefinirElemento(int pos, String valor) {
        if (pos <= getTamanho()) {
            v[pos] = valor;
        }
